	...
	public static function getMap()
	{
		return array(
			'ID' => array(
				...
				'primary' => true,
				'autocomplete' => true,
				'title' => Loc::getMessage('SHIPMENT_ENTITY_ID_FIELD'),
			),
			'DOC_ID' => array(
				'data_type' => 'string',
				'validation' => array(__CLASS__, 'validateDocId'),
				'title' => Loc::getMessage('SHIPMENT_ENTITY_DOC_ID_FIELD'),
			),
			'FC_BP' => array(
				'data_type' => 'string',
				'validation' => array(__CLASS__, 'validateFcBp'),
				'title' => Loc::getMessage('SHIPMENT_ENTITY_FC_BP_FIELD'),
			),
			'JSON' => array(
				'data_type' => 'text',
				'title' => Loc::getMessage('SHIPMENT_ENTITY_JSON_FIELD'),
			),
			'FK_DOC_NUM' => array(
				'data_type' => 'string',
				'validation' => array(__CLASS__, 'validateFkDocNum'),
				'title' => Loc::getMessage('SHIPMENT_ENTITY_FK_DOC_NUM_FIELD'),
			),
			'FD_DOC_DATE' => array(
				'data_type' => 'datetime',
				'title' => Loc::getMessage('SHIPMENT_ENTITY_FD_DOC_DATE_FIELD'),
			),
			'FC_METAL_PT' => array(
				'data_type' => 'string',
				'validation' => array(__CLASS__, 'validateFcMetalPt'),
				'title' => Loc::getMessage('SHIPMENT_ENTITY_FC_METAL_PT_FIELD'),
			),
			'FC_METAL_PD' => array(
				'data_type' => 'string',
				'validation' => array(__CLASS__, 'validateFcMetalPd'),
				'title' => Loc::getMessage('SHIPMENT_ENTITY_FC_METAL_PD_FIELD'),
			),
			'FC_METAL_RH' => array(
				'data_type' => 'string',
				'validation' => array(__CLASS__, 'validateFcMetalRh'),
				'title' => Loc::getMessage('SHIPMENT_ENTITY_FC_METAL_RH_FIELD'),
			),
			'FC_METAL_IR' => array(
				'data_type' => 'string',
				'validation' => array(__CLASS__, 'validateFcMetalIr'),
				'title' => Loc::getMessage('SHIPMENT_ENTITY_FC_METAL_IR_FIELD'),
			),
			'FC_METAL_RU' => array(
				'data_type' => 'string',
				'validation' => array(__CLASS__, 'validateFcMetalRu'),
				'title' => Loc::getMessage('SHIPMENT_ENTITY_FC_METAL_RU_FIELD'),
			),
			'FC_METAL_OS' => array(
				'data_type' => 'string',
				'validation' => array(__CLASS__, 'validateFcMetalOs'),
				'title' => Loc::getMessage('SHIPMENT_ENTITY_FC_METAL_OS_FIELD'),
			),
			'FC_METAL_AU' => array(
				'data_type' => 'string',
				'validation' => array(__CLASS__, 'validateFcMetalAu'),
				'title' => Loc::getMessage('SHIPMENT_ENTITY_FC_METAL_AU_FIELD'),
			),
			'FC_METAL_AG' => array(
				'data_type' => 'string',
				'validation' => array(__CLASS__, 'validateFcMetalAg'),
				'title' => Loc::getMessage('SHIPMENT_ENTITY_FC_METAL_AG_FIELD'),
			),
			'FC_METAL_RE' => array(
				'data_type' => 'string',
				'validation' => array(__CLASS__, 'validateFcMetalRe'),
				'title' => Loc::getMessage('SHIPMENT_ENTITY_FC_METAL_RE_FIELD'),
			),
			'IS_STORNO' => array(
				'data_type' => 'integer',
				'title' => Loc::getMessage('SHIPMENT_ENTITY_IS_STORNO_FIELD'),
			),
		);
	}
	/**
